...
It means, there are no real NULLs in exclusions column, empty values are string ' ', but there are fake 'null'-s (strings)
...
There is 1 real NULL in extras column, empty values are string ' ', but there are fake 'null'-s (strings)
